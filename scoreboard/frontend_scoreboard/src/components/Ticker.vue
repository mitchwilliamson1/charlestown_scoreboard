...
export default {
  ...
  computed: {
    score() {
      return parseInt(this.player.score)
    },
    addstyle() {
  ...
  methods: {
    scoreUp() {
      if(typeof this.score !== "undefined") {
        ...
        update: {score: this.score, player_id: this.player.player_id, game_id:this.details.game_id}
        })
    ...
    endsUp() {
      ...
      update: {ends: this.ends, game_id:this.details.game_id}
      })
      .then(function (response) {
        console.log(response);
      })
